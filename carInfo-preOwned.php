...
?>
<!DOCTYPE html>
<?php $thisPage="preOwned"; $fileName='carInfo-preOwned.php';?>
        ...
        <main class="container">
            <div class="px-3">
                <div class="row backLink mb-3">
                    <a class="align-middle" href="pre-owned.php">&nbsp;Back</a>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 pt-4 pt-lg-2 pl-lg-4">
                    <?php 
                        $ret1 = $db->query($sql);
                        while($row = $ret1->fetchArray(SQLITE3_ASSOC) ) {?>
                            <h2><?php echo $row['Model']?>&nbsp;<span class='badge badge-primary'>pre-owned</span></h2>
