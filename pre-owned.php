<?php 
    ...
    $thisPage="preOwned"; $fileName='pre-owned.php';
...
<html lang="en">
    ...
    <body>
        ...
        <main class="container">
            <div class="offset-md-1"><h1>Pre-owned Car</h1></div>
                            ...
                            <div class="card">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col textContainer">
                                        ...
                                        <form method="POST" action="pre-owned.php">
                                            ...
                                            <div class="card-block py-3 px-3">
                                                ...
                                                <h4 class="card-title mb-1"><a href="carInfo-preOwned.php?Model='<?php echo $url;?>'"><?php echo $model;?></a></h4>
